...
item_one = Item.create!(name: 'Executive Suite', location: 'Nairobi CBD',
                        image: 'https://stylesatlife.com/wp-content/uploads/2019/11/best-office-table-designs.jpg', description: 'A place to work')
...
item_two = Item.create!(name: 'Traditional Office Space', location: 'Nairobi CBD',
                        image: 'https://stylesatlife.com/wp-content/uploads/2019/11/best-office-table-designs.jpg', description: 'A place to work')
...
item_three = Item.create!(name: 'Creative Office Space', location: 'Nairobi CBD',
                          image: 'https://stylesatlife.com/wp-content/uploads/2019/11/best-office-table-designs.jpg', description: 'A place to work')
...
item_four = Item.create!(name: 'Contiguous Office Space', location: 'Nairobi CBD',
                         image: 'https://stylesatlife.com/wp-content/uploads/2019/11/best-office-table-designs.jpg', description: 'A place to work')
...
item_five = Item.create!(name: 'Coworking Space', location: 'Nairobi CBD',
                         image: 'https://stylesatlife.com/wp-content/uploads/2019/11/best-office-table-designs.jpg', description: 'A place to work')
item_five.services.create!(name: 'Coffee')

item_six = Item.create!(name: 'Shared Office Space', location: 'Nairobi CBD',
                        image: 'https://stylesatlife.com/wp-content/uploads/2019/11/best-office-table-designs.jpg', description: 'A place to work')
